...
import CartUpdateBtn from "./CartUpdateBtn";
                  ...
                  <TableBody>
                    {cart &&
                      ...
                      cart.map((item, index) => {
                        ...
                        let currentItem = cartState[productId];
                        return (
                          <TableRow key={item.cart_id}>
                            ...
                            <TableCell align="right">
                              <FormControl>
                                <Select
                                  value={cartState[productId].selectedSizeId}
                                  onChange={(e) =>
                                    handleSelectedSizeChange(
                                      productId,
                                      e.target.value
                            ...
                            <TableCell align="right">
                              <FormControl>
                                <Select
                                  value={cartState[productId].selectedQuantity}
                                  onChange={(e) =>
                                    handleSelectedQuantityChange(
                                      productId,
                                      e.target.value
                                ...
                                >
                                  {Array.from(
                                    {
                                      length:
                                        cartState[productId].sizes[
                                          cartState[productId].selectedSizeId
                                        ].pivot.quantity,
                                    },
                                    (_, i) => i + 1
                                  ).map((val) => {
